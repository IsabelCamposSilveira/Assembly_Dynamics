...
namespace plugins_default_plugins
{
    /// <summary>
    ...
    public interface ILocalPluginContext
    {
        ...
        /// The PowerPlatform Dataverse organization service for the Account that was registered to run this plugin, This could be the same user as InitiatingUserService.
        /// </summary>
        IOrganizationService PluginAdminImpersonatedService { get; }
    ...
    public class LocalPluginContext : ILocalPluginContext
    {
        ...
        public IOrganizationService PluginAdminImpersonatedService { get; }
        ...
        public LocalPluginContext(IServiceProvider serviceProvider)
        {
            ...
            PluginAdminImpersonatedService = this.OrgSvcFactory.CreateOrganizationService(null);
        }
